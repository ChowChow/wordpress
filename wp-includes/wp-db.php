...
<p>Se não sabe configurar uma base de dados, deverá <strong>entrar em contacto com o seu serviço de alojamento</strong> . Se nada disto resultar poderá ainda encontrar ajuda no <a href="http://pt.forums.wordpress.org/">Fórum de Suporte do WordPress</a>.</p>'/*/WP_I18N_DB_SELECT_DB*/, htmlspecialchars( $db, ENT_QUOTES ), htmlspecialchars( $this->dbuser, ENT_QUOTES ) ), 'db_select_fail' );
			return;
		}
	}
