...
if ( file_exists( ABSPATH . 'wp-config.php') ) {
	...
	wp_die(sprintf(/*WP_I18N_NO_CONFIG*/'<p>Parece não existir um ficheiro <code> wp-config.php </code>. Esse ficheiro é necessário antes de podermos começar.</p><p>Precisa de mais ajuda? <a href=\'http://codex.wordpress.org/Editing_wp-config.php\'>Temos aqui</a>.</p><p>Pode sempre criar um ficheiro <code>wp-config.php </code> através de uma interface web, mas isso não funciona sempre com algumas configurações de servidor. A maneira mais segura é criar manualmente o ficheiro.</p><p><a href=\'%ssetup-config.php\' class=\'button\'>Criar o ficheiro de configuração agora</a></p>'/*/WP_I18N_NO_CONFIG*/, $path), /*WP_I18N_ERROR_TITLE*/'WordPress &rsaquo; Erro'/*/WP_I18N_ERROR_TITLE*/, array('text_direction' => $text_direction));
